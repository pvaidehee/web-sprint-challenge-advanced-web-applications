...
It is used for digital encryption using a public/private key. A digital signature of sorts.

2. What steps can you take in your web apps to keep your data secure?

Could use JSON web tokens for authorization headers, as this will help secure your app from unwanted outside sources.

3. Describe how web servers work.

They store, process and deliver web pages to the clients.
